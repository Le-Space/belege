// Ported from Le-Space/simple-todo apps/escrow01 (src/lib/technical-view.spec.js) at f0d3df4.
// Changed: the belege. key, and a stubbed localStorage (these tests run in Node).
...
describe('the technical view setting', () => {
	...
	it('lives under the app’s belege. prefix', () => {
		expect(TECHNICAL_VIEW_STORAGE_KEY).toBe('belege.technicalView');
	});
	...
	it('uses the browser’s localStorage by default', () => {
		// The unit tests run in Node; a stand-in for the browser's storage.
