...
| **„KI-Vorschlag“ unter „Beleg zuordnen“** (`bridge/src/llm/match-assist.js`, `POST /match/assist`) | der Knopf in der Liste der Belege zur Auswahl                                                                                                   | Gegenpartei, Verwendungszweck, Betrag und Tag der Buchung, dazu bis zu 25 Belege, nach Betrag und Datum am nächsten, mit ihren ausgelesenen Feldern (Anbieter, Betrag, Währung, Datum, Rechnungsnummer, Kurzbeschreibung), geschwärzt | welcher Beleg passt, wie sicher, und warum in wenigen Worten; zuordnen bleibt dein Klick                                                                                               |
